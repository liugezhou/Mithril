...
```
> 为了让事情变得更简单，你可以把这支已经装载了mithril最新版本的笔分叉。(原文：To make things simpler you can fork this pen which already has the latest version of mithril loaded.) 
...
Hello World!
```
> Mithril也已经加载到这个页面了，所以如果你愿意，你可以马上在开发控制台中打开m对象
